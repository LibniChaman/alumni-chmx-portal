        ...
        <form className="space-y-4">
          <div>
            <input
              type="email"
              placeholder="Email"
              className="w-full px-4 py-3 border rounded-lg text-sm placeholder:text-gray-300 focus:ring-2 focus:ring-blue-200 focus:outline-none"
            />
          </div>
          <div>
            <input
              ...
              className="w-full px-4 py-3 border rounded-lg text-gray-200 placeholder:text-gray-300 focus:ring-2  focus:ring-blue-200 focus:outline-none"
            />
          </div>
